...
public class ArtemisFeatureWithCoreTest extends Assert {

   private static Logger LOG = Logger.getLogger(ArtemisFeatureWithCoreTest.class.getName());
...
//          debugConfiguration("5005", true),
         features(getArtemisMQKarafFeatureUrl(), f.toArray(new String[f.size()])),KarafDistributionOption.replaceConfigurationFile("etc/artemis.xml", new File(ArtemisFeatureMultiProtocolTest.class.getClassLoader().getResource("artemis-core.xml").toURI()))};

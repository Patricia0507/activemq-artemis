...
public class ArtemisFeatureMultiProtocolTest extends Assert {

   private static Logger LOG = Logger.getLogger(ArtemisFeatureMultiProtocolTest.class.getName());
   ...
   @Configuration
   public static Option[] configure() throws URISyntaxException {
      return configure("artemis");
   }

   public static Option[] configure(String... features) throws URISyntaxException {
...
//          debugConfiguration("5005", true),
         features(getArtemisMQKarafFeatureUrl(), f.toArray(new String[f.size()])),KarafDistributionOption.replaceConfigurationFile("etc/artemis.xml", new File(ArtemisFeatureMultiProtocolTest.class.getClassLoader().getResource("artemis-empty.xml").toURI()))};
